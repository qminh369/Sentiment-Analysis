...
btn = driver.find_element(By.XPATH, "//button[@class = 'c89f1057d c08709d93 cfdf7e7ce c948a708e _button-login-password']")
btn.click()
time.sleep(2)
...
for i in range(3):
    ...
    with open('B:\\Đồ án I\\Project I\\selenium automatic chatgpt\\result.txt', 'a', encoding = 'utf-8') as file:
        file.write(result + '\n')
